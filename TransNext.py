...
class AggregatedAttention(nn.Module):
    ...
    def forward(self, x, H, W, relative_pos_index, relative_coords_table, seq_length_scale, padding_mask):
        ...
        # q_norm:[1, 3, 784, 24], attn_local:[1, 3, 784, 9], (..):[1, 3, 784, 1, 9], v_local:[1, 3, 784, 24, 9], v_local.transpose(-2, -1):[1, 3, 784, 9, 24], (...):[1, 3, 784, 1, 24]
...
class TransNeXt(nn.Module):
    ...
    def __init__(self, img_size=224, pretrain_size=None, window_size=[3, 3, 3, None],
                 patch_size=16, in_chans=32, num_classes=1000, embed_dims=[64, 128, 256, 512],
...
class transnext_tiny(TransNeXt):
    def __init__(self, img_size=224):
        super().__init__(img_size=img_size, window_size=[3, 3, 3, None],
                         ...
                         pretrained=None, pretrain_size=224)
